...
type IncomeType = {
    income_id: number;
    user_id: string; // should be a string since it's a Firebase UID
    source: string;
    amount: number;
    month: number;
    year: number;
...
const IncomeModal = () => {
    ...
    const [income, setIncome] = useState<IncomeType>({
        income_id: 0,
        user_id: "", // changed from number to string
        source: "",
        amount: 0,
        month: 0,
        year: 0,
    ...
    const onSubmit = async () => {
        ...
        const data: IncomeType = {
            income_id: 0, // this is auto-generated by the server
            user_id: user?.uid ?? "", // ensure correct user_id from Firebase
            source,
            amount,
